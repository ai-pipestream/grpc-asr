...
`/work/main/grpc-services/gRParse (CMake, health, metrics) and /work/main/grpc-services/grpc-libreoffice (C++ gRPC server shape)`.
...
- **Forgejo** (`git.rokkon.com/ai-pipestream/grpc-asr`) is the source of truth. `main` lives here.
